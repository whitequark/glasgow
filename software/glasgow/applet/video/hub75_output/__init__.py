...
class Hub75Output(Elaboratable):
...
class Hub75OutputSubtarget(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m.submodules.output = output = Hub75Output(self.pads)
...
class Hub75OutputApplet(GlasgowApplet, name="video-hub75-output"):
    ...
    def build(self, target, args):
        ...
        subtarget = iface.add_subtarget(Hub75OutputSubtarget(
...
class Hub75OutputAppletTestCase(GlasgowAppletTestCase, applet=Hub75OutputApplet):
    @synthesis_test
    def test_build(self):
        self.assertBuilds()
