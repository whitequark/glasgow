...
class IOStreamTestCase(unittest.TestCase):
    ...
    def test_skid(self):
        ...
        async def testbench(ctx):
            ...
            assert i_stream_p.port.i == 0b0101, f"{i_stream_p.i:#06b}"
            ...
            assert o_stream_ready == 0
            assert i_stream_valid == 1
            assert i_stream_p.port.i == 0b1100, f"{i_stream_p.i:#06b}"
            ...
            assert o_stream_ready == 1
            assert i_stream_valid == 1
            assert i_stream_p.port.i == 0b1001, f"{i_stream_p.i:#06b}"
